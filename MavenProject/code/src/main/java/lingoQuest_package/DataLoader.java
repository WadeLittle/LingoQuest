...
public class DataLoader {
    ...
    public static void main(String[] args) {
        // Example usage
        String filePath = "/Users/cadestocker/Desktop/Fall 24/247/Group Project/LingoQuest/DataLoader/dataloader/src/main/java/dataloader_package/Users.json"; // JSON file containing User objects
        ArrayList<User> users = loadData(filePath);
